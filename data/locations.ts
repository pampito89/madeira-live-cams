import { activityLocations } from "./activities";
...
export function getLocalizedLocation(location: Location, locale: Locale): DisplayLocation {
    return {
        slug: location.slug,
        ...
        article: {
            ...
            highlights: location.article.highlights[locale].map((highlight) => keepOriginalPlaceNames(highlight, locale)),
            practicalTip: keepOriginalPlaceNames(location.article.practicalTip[locale], locale),
        },
    };
}
function createContinenteModeloLocation({ slug, name, area, latitude, longitude, }: {
    slug: string;
    name: string;
    area: string;
    latitude: number;
...
function createPingoDoceLocation({ slug, name, area, latitude, longitude, }: {
    slug: string;
    name: string;
    area: string;
    latitude: number;
    ...
    return {
        slug,
        name: { en: name, uk: name },
        area: { en: area, uk: area },
        category: { en: 'Supermarket', uk: 'Супермаркет' },
        tags: ['Supermarkets'],
        hiddenFromExplore: true,
        summary: {
            en: 'Pingo Doce supermarket for groceries, fresh food, drinks and everyday travel essentials.',
            uk: 'Супермаркет Pingo Doce для продуктів, свіжої їжі, напоїв і потрібних товарів у дорогу.',
        },
        image: '/images/explore/pingo-doce.jpg',
        imageAlt: {
            en: 'Pingo Doce supermarket in Madeira',
            uk: 'Супермаркет Pingo Doce на Мадейрі',
        },
        mapQuery: `${latitude},${longitude}`,
        article: {
            intro: {
                en: `${name} is a Pingo Doce supermarket in ${area}, Madeira. It is a practical stop for groceries, fresh food, drinks and travel essentials.`,
                uk: `${name} — супермаркет Pingo Doce у районі ${area} на Мадейрі. Це зручна зупинка для продуктів, свіжої їжі, напоїв і товарів у дорогу.`,
            },
            history: {
                en: 'Pingo Doce is a Portuguese supermarket brand. This location is included as a practical stop for visitors and tour leaders.',
                uk: 'Pingo Doce — португальська мережа супермаркетів. Цю локацію додано як практичну зупинку для гостей і турлідерів.',
            },
            highlights: {
                en: [
                    'Groceries and fresh food',
                    'Drinks and everyday essentials',
                    'Useful stop before villa check-in',
                    'Directions available through Google Maps',
                ],
                uk: [
                    'Продукти та свіжа їжа',
                    'Напої й товари щоденного вжитку',
                    'Зручна зупинка перед заселенням на віллу',
                    'Маршрут доступний через Google Maps',
                ],
            },
            practicalTip: {
                en: 'Check current opening hours before travelling. Add this supermarket to the trip plan when you need time for groceries before continuing the route.',
                uk: 'Перед поїздкою перевірте актуальні години роботи. Додайте цей супермаркет до плану подорожі, коли потрібно передбачити час на покупки перед продовженням маршруту.',
            },
        },
    };
}
const pingoDoceLocations: Location[] = [
    createPingoDoceLocation({
        slug: 'pingo-doce-machico',
        name: 'Pingo Doce Super Machico',
        area: 'Machico',
        latitude: 32.7198279,
        longitude: -16.7677055,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-camara-de-lobos',
        name: 'Pingo Doce Super Câmara de Lobos',
        area: 'Câmara de Lobos',
        latitude: 32.6493188,
        longitude: -16.9750799,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-plaza-madeira',
        name: 'Pingo Doce Plaza Madeira',
        area: 'São Martinho, Funchal',
        latitude: 32.6369198,
        longitude: -16.9438398,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-anadia',
        name: 'Pingo Doce Super Anadia',
        area: 'Funchal Old Town',
        latitude: 32.649296,
        longitude: -16.904707,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-funchal',
        name: 'Pingo Doce Funchal',
        area: 'Funchal',
        latitude: 32.6369174,
        longitude: -16.9316492,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-ribeira-brava',
        name: 'Pingo Doce Ribeira Brava',
        area: 'Ribeira Brava',
        latitude: 32.670003,
        longitude: -17.0641829,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-santo-antonio',
        name: 'Pingo Doce Super Santo António',
        area: 'Santo António, Funchal',
        latitude: 32.663891,
        longitude: -16.9393958,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-brito-camara',
        name: 'Pingo Doce Brito Câmara',
        area: 'Funchal',
        latitude: 32.6475054,
        longitude: -16.9135832,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-penteada',
        name: 'Pingo Doce Penteada',
        area: 'Funchal',
        latitude: 32.6634256,
        longitude: -16.9286206,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-cancela',
        name: 'Pingo Doce Super Cancela',
        area: 'Cancela',
        latitude: 32.6466833,
        longitude: -16.857411,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-monumental',
        name: 'Pingo Doce Super Monumental',
        area: 'Funchal',
        latitude: 32.638662,
        longitude: -16.9345364,
    }),
    createPingoDoceLocation({
        slug: 'pingo-doce-calheta',
        name: 'Pingo Doce Super Calheta',
        area: 'Calheta',
        latitude: 32.7197258,
        longitude: -17.1740178,
    }),
];
export const locations: Location[] = [
    ...
    },
    {
        ...
        article: {
            ...
            history: {
                en: 'Madeira Airport opened in 1964 with a runway of about 1,600 metres, a major change for an island that had long depended on sea connections. However, the airport was built in an exceptionally constrained setting: mountains rise close behind it, while the Atlantic Ocean lies directly in front of the runway. The short original runway limited operations and left little room for error in difficult weather. A first extension of around 200 metres was completed in the 1980s, bringing the runway to about 1,800 metres, but Madeira still needed a larger solution for modern commercial aviation and growing tourism. The limitations of the old airport were tragically highlighted on 19 November 1977, when TAP Air Portugal Flight 425, a Boeing 727 arriving from Lisbon, overran the wet runway during landing. The aircraft had touched down well beyond its intended point and above the recommended speed; difficult weather and aquaplaning reduced braking effectiveness. The aircraft fell beyond the runway and 131 of the 164 people on board died. The accident did not have one single cause, but it underlined the risks created by a short runway, challenging weather and steep terrain. The decisive expansion opened in 2000. Because there was no flat land available, engineers extended the runway over the sea on a huge elevated structure supported by 180 reinforced-concrete pillars. The project brought the runway to about 2,781 metres and was designed for the loads of large aircraft such as the Boeing 747-400. It became one of Madeira’s most important modern engineering works and received the IABSE Outstanding Structure Award in 2004. In 2017, the airport was renamed Cristiano Ronaldo Madeira International Airport in honour of the footballer born in Funchal.',
                uk: 'Аеропорт Мадейри відкрили у 1964 році зі злітною смугою завдовжки приблизно 1 600 метрів, що стало великою зміною для острова, який тривалий час залежав від морського сполучення. Проте аеропорт збудували в надзвичайно обмежених умовах: позаду близько підходять гори, а прямо перед смугою лежить Атлантичний океан. Коротка початкова смуга обмежувала роботу аеропорту та майже не залишала простору для помилки за складної погоди. У 1980-х роках завершили перше подовження приблизно на 200 метрів — до близько 1 800 метрів, але Мадейра все ще потребувала масштабнішого рішення для сучасної комерційної авіації та зростаючого туризму. Обмеження старого аеропорту трагічно проявилися 19 листопада 1977 року, коли рейс TAP Air Portugal 425 — Boeing 727 із Лісабона — під час посадки викотився за межі мокрої смуги. Літак торкнувся землі значно далі від запланованої точки та на швидкості вищій за рекомендовану; складна погода й аквапланування зменшили ефективність гальмування. Літак упав за межами смуги, і 131 із 164 людей на борту загинула. Катастрофа не мала однієї єдиної причини, але вона підкреслила ризики, пов’язані з короткою смугою, складною погодою та крутим рельєфом. Вирішальне розширення відкрили у 2000 році. Оскільки поруч не було рівнинної землі, інженери подовжили смугу над морем на величезній піднятій конструкції, яку підтримують 180 залізобетонних опор. Проєкт збільшив довжину смуги приблизно до 2 781 метра та був розрахований на навантаження великих літаків, зокрема Boeing 747-400. Він став однією з найважливіших сучасних інженерних споруд Мадейри й отримав IABSE Outstanding Structure Award у 2004 році. У 2017 році аеропорт перейменували на Cristiano Ronaldo Madeira International Airport на честь футболіста, який народився у Funchal.',
            },
            highlights: {
                en: [
                    'Madeira’s main international airport, with the IATA code FNC',
                    'Opened in 1964 with an original runway of about 1,600 metres',
                    'The 1977 TAP Flight 425 disaster highlighted the operational limits of the old runway; 131 of 164 people on board died',
                    'An initial runway extension in the 1980s increased the length to around 1,800 metres',
                    'The major 2000 expansion extended the runway to about 2,781 metres',
                    'Part of the runway stands over the Atlantic on 180 reinforced-concrete pillars',
                    'The extension was designed to support large aircraft loads, including Boeing 747-400 operations',
                    'The project received the IABSE Outstanding Structure Award in 2004',
                ],
                uk: [
                    'Головний міжнародний аеропорт Мадейри з кодом IATA FNC',
                    'Відкритий у 1964 році з початковою злітною смугою приблизно 1 600 метрів',
                    'Катастрофа TAP Flight 425 у 1977 році показала експлуатаційні обмеження старої смуги; загинула 131 людина із 164 на борту',
                    'Перше подовження у 1980-х роках збільшило довжину приблизно до 1 800 метрів',
                    'Масштабне розширення 2000 року збільшило довжину смуги приблизно до 2 781 метра',
                    'Частина смуги стоїть над Атлантикою на 180 залізобетонних опорах',
                    'Розширення розрахували на навантаження великих літаків, зокрема Boeing 747-400',
                    'Проєкт отримав IABSE Outstanding Structure Award у 2004 році',
                ],
            },
            practicalTip: {
