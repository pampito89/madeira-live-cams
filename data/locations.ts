...
export const locations: Location[] = [
  ...
  },
  {
    ...
    article: {
      intro:
        'Monte Palace Tropical Garden sits above Funchal in the cooler hills of Monte. It is an easy way to combine gardens, city views and the famous cable-car route from Funchal.',
      history:
        'The garden developed around the historic Monte Palace estate and is now known for its landscaped paths, lakes and collections of plants and art.',
      highlights: [
        'Tropical and subtropical plants on hillside paths',
        'Views over Funchal Bay',
        'A natural pairing with the Funchal–Monte cable car',
      ],
      practicalTip:
        'Wear comfortable shoes: the garden is large and has slopes, steps and uneven paths.',
    },
  },
  {
    slug: 'funchal',
  ...
  },
  {
    ...
    imageAlt: 'Volcanic natural swimming pools in Porto Moniz, Madeira',
    mapQuery: 'Porto Moniz Natural Swimming Pools Madeira',
    article: {
      intro:
        'Porto Moniz Natural Swimming Pools are seawater pools formed among black volcanic rocks on Madeira’s north-west coast.',
      history:
        'The pools are shaped by volcanic geology and receive fresh Atlantic water through natural openings in the rock.',
      highlights: [
      ...
      practicalTip:
        'Check opening times, local sea conditions and wind before travelling; the coast can be rough outside calm periods.',
    },
  },
];
