...
const copy = {
  en: {
    ...
    distance: 'The full circuit is roughly 8 km, including the uphill approach. Allow extra time for stops.',
  ...
  uk: {
    ...
    distance: 'Повне коло разом із підходом угору — орієнтовно 8 км. Додайте час на зупинки.',
