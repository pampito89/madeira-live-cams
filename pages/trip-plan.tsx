...
export default function TripPlanPage() {
    ...
    const startPointName = isAirportStart ? (locale === "uk" ? "\u0410\u0435\u0440\u043E\u043F\u043E\u0440\u0442 \u041C\u0430\u0434\u0435\u0439\u0440\u0438" : "Madeira Airport") : isCustomStart ? (customCoordinates.point?.name ?? (locale === "uk" ? "\u0414\u043E\u0432\u0456\u043B\u044C\u043D\u0430 \u0442\u043E\u0447\u043A\u0430" : "Custom point")) : selectedVilla.name;
    const startCoordinates: [
        number,
        number
    ] | null = isAirportStart ? [airportStartPoint.latitude, airportStartPoint.longitude] : isCustomStart ? customCoordinates.coordinates : [selectedVilla.latitude, selectedVilla.longitude];
    const selectedEndPointName = isAirportEnd ? (locale === "uk" ? "\u0410\u0435\u0440\u043E\u043F\u043E\u0440\u0442 \u041C\u0430\u0434\u0435\u0439\u0440\u0438" : "Madeira Airport") : isCustomEnd ? (endCustomCoordinates.point?.name ?? (locale === "uk" ? "\u0414\u043E\u0432\u0456\u043B\u044C\u043D\u0430 \u0442\u043E\u0447\u043A\u0430" : "Custom point")) : selectedEndVilla?.name ?? "";
    const selectedEndCoordinates: [
        number,
        number
    ] | null = isAirportEnd ? [airportStartPoint.latitude, airportStartPoint.longitude] : isCustomEnd ? endCustomCoordinates.coordinates : selectedEndVilla ? [selectedEndVilla.latitude, selectedEndVilla.longitude] : null;
