...
function durationLabel(minutes: number, locale: 'en' | 'uk') { const hours = Math.floor(minutes / 60); const remaining = minutes % 60; if (locale === 'uk') return hours === 0 ? `${remaining} С…РІ` : remaining === 0 ? `${hours} РіРѕРґ` : `${hours} РіРѕРґ ${remaining} С…РІ`; return hours === 0 ? `${remaining} min` : remaining === 0 ? `${hours} hr` : `${hours} hr ${remaining} min`; }
function adviceForWeather(temperature: number, rain: number, locale: 'en' | 'uk') { if (locale === 'uk') { const clothing = temperature < 12 ? 'РћРґСЏРіР°Р№С‚РµСЃСЏ С‚РµРїР»Рѕ С– С€Р°СЂР°РјРё: С‚РµРїР»Р° РєРѕС„С‚Р°, РІС–С‚СЂРѕР·Р°С…РёСЃРЅР° РєСѓСЂС‚РєР° С‚Р° Р·Р°РєСЂРёС‚Рµ РІР·СѓС‚С‚СЏ.' : temperature < 20 ? 'РћРґСЏРіР°Р№С‚РµСЃСЏ С€Р°СЂР°РјРё: Р»РµРіРєР° РєРѕС„С‚Р° Р°Р±Рѕ РІС–С‚СЂРѕРІРєР° Р±СѓРґРµ РґРѕСЂРµС‡РЅРѕСЋ.' : 'РџС–РґС–Р№РґРµ Р»РµРіРєРёР№ РѕРґСЏРі, Р°Р»Рµ РІС–Р·СЊРјС–С‚СЊ С‚РѕРЅРєСѓ РєРѕС„С‚Сѓ Р°Р±Рѕ РІС–С‚СЂРѕРІРєСѓ РЅР° РІРµС‡С–СЂ С‚Р° РґР»СЏ РіС–СЂ.'; return `${rain >= 30 ? 'Р™РјРѕРІС–СЂРЅС–СЃС‚СЊ РґРѕС‰Сѓ РґРѕСЃС‚Р°С‚РЅСЏ вЂ” РІС–Р·СЊРјС–С‚СЊ РґРѕС‰РѕРІРёРє.' : 'Р™РјРѕРІС–СЂРЅС–СЃС‚СЊ РґРѕС‰Сѓ РЅРµРІРёСЃРѕРєР°, Р°Р»Рµ Р»РµРіРєРёР№ РґРѕС‰РѕРІРёРє Сѓ РњР°РґРµР№СЂС– РІСЃРµ РѕРґРЅРѕ Р±СѓРґРµ РєРѕСЂРёСЃРЅРёРј.'} ${clothing}`; } const clothing = temperature < 12 ? 'Dress warmly in layers: a warm mid-layer, windproof jacket and closed shoes.' : temperature < 20 ? 'Dress in layers; a light fleece or windbreaker is recommended.' : 'Light clothing is suitable, but bring a thin layer or windbreaker for the evening and mountains.'; return `${rain >= 30 ? 'Rain is possible, so take a rain jacket.' : 'Rain risk is low, but a light rain jacket is still useful in Madeira.'} ${clothing}`; }
...
export default function TripPlanPage() {
  ...
  const text = locale === 'uk' ? {
    title: 'РџР»Р°РЅ РїРѕРґРѕСЂРѕР¶С–', intro: 'РЎС‚РІРѕСЂС–С‚СЊ РїСЂРѕСЃС‚Сѓ РїСЂРѕРіСЂР°РјСѓ РґРЅСЏ: РѕР±РµСЂС–С‚СЊ РІС–Р»Р»Сѓ, РґРѕРґР°Р№С‚Рµ Р»РѕРєР°С†С–С—, СЂРµСЃС‚РѕСЂР°РЅ С– С‡Р°СЃ РґР»СЏ РєРѕР¶РЅРѕС— Р·СѓРїРёРЅРєРё.', dayDetails: 'Р”РµС‚Р°Р»С– РґРЅСЏ', date: 'Р”Р°С‚Р°', startVilla: 'РЎС‚Р°СЂС‚РѕРІР° РІС–Р»Р»Р°', departure: 'Р§Р°СЃ РІРёС—Р·РґСѓ', addStop: 'Р”РѕРґР°С‚Рё С‚РѕС‡РєСѓ', location: 'Р›РѕРєР°С†С–СЏ', locationFilters: 'Р¤С–Р»СЊС‚СЂ Р»РѕРєР°С†С–Р№', chooseLocation: 'РћР±РµСЂС–С‚СЊ Р»РѕРєР°С†С–СЋ', addLocation: 'Р”РѕРґР°С‚Рё Р»РѕРєР°С†С–СЋ', addRestaurant: 'Р”РѕРґР°С‚Рё СЂРµСЃС‚РѕСЂР°РЅ', addVilla: 'Р”РѕРґР°С‚Рё РїРѕРІРµСЂРЅРµРЅРЅСЏ РЅР° РІС–Р»Р»Сѓ', selectedStops: 'РњР°СЂС€СЂСѓС‚ РґРЅСЏ', noStops: 'Р”РѕРґР°Р№С‚Рµ РїРµСЂС€Сѓ Р»РѕРєР°С†С–СЋ Р°Р±Рѕ СЂРµСЃС‚РѕСЂР°РЅ, С‰РѕР± СЃС„РѕСЂРјСѓРІР°С‚Рё РјР°СЂС€СЂСѓС‚.', arrival: 'РџСЂРёР±СѓС‚С‚СЏ', duration: 'РўСЂРёРІР°Р»С–СЃС‚СЊ', sunrise: 'РЎС…С–Рґ СЃРѕРЅС†СЏ', bar: 'Р‘Р°СЂ', restaurantOption: 'Р РµСЃС‚РѕСЂР°РЅ', meal: 'РџСЂРёР№РѕРј С—Р¶С–', breakfast: 'РЎРЅС–РґР°РЅРѕРє', lunch: 'РћР±С–Рґ', dinner: 'Р’РµС‡РµСЂСЏ', up: 'Р’РёС‰Рµ', down: 'РќРёР¶С‡Рµ', remove: 'Р’РёРґР°Р»РёС‚Рё', restaurant: 'Р РµСЃС‚РѕСЂР°РЅ', output: 'Р“РѕС‚РѕРІР° РїСЂРѕРіСЂР°РјР°', share: 'РџРѕРґС–Р»РёС‚РёСЃСЏ', copied: 'РЎРєРѕРїС–Р№РѕРІР°РЅРѕ', clear: 'РћС‡РёСЃС‚РёС‚Рё РјР°СЂС€СЂСѓС‚', return: 'РџРѕРІРµСЂРЅРµРЅРЅСЏ РґРѕ', departureFrom: 'РІРёС—Р·Рґ Р·', defaultProgram: 'Р”РѕРґР°Р№С‚Рµ С‚РѕС‡РєРё РјР°СЂС€СЂСѓС‚Сѓ вЂ” С‚СѓС‚ Р·вЂ™СЏРІРёС‚СЊСЃСЏ РіРѕС‚РѕРІР° РїСЂРѕРіСЂР°РјР° РґР»СЏ РєРѕРїС–СЋРІР°РЅРЅСЏ.', recommendations: 'Р РµРєРѕРјРµРЅРґР°С†С–С— РЅР° РґРµРЅСЊ', weather: 'РџРѕРіРѕРґР°', beach: 'РџР»СЏР¶', levada: 'Р›РµРІР°РґР°', weatherLoading: 'Р—Р°РІР°РЅС‚Р°Р¶СѓС”РјРѕ Р°РєС‚СѓР°Р»СЊРЅРёР№ РїСЂРѕРіРЅРѕР·вЂ¦', weatherUnavailable: 'РђРєС‚СѓР°Р»СЊРЅРёР№ РїСЂРѕРіРЅРѕР· РґР»СЏ РѕР±СЂР°РЅРѕС— РґР°С‚Рё РЅРµРґРѕСЃС‚СѓРїРЅРёР№. РџРµСЂРµРІС–СЂС‚Рµ РїРѕРіРѕРґСѓ РїРµСЂРµРґ РІРёС—Р·РґРѕРј.',
  } : {
    title: 'Trip plan', intro: 'Create a simple day itinerary: choose a villa, add locations, a restaurant stop and timing for each point.', dayDetails: 'Day details', date: 'Date', startVilla: 'Starting villa', departure: 'Departure time', addStop: 'Add a stop', location: 'Location', locationFilters: 'Location filters', chooseLocation: 'Choose a location', addLocation: 'Add location', addRestaurant: 'Add restaurant', addVilla: 'Add villa return', selectedStops: 'Day route', noStops: 'Add your first location or restaurant to build the route.', arrival: 'Arrival', duration: 'Duration', sunrise: 'Sunrise', bar: 'Bar', restaurantOption: 'Restaurant', meal: 'Meal', breakfast: 'Breakfast', lunch: 'Lunch', dinner: 'Dinner', up: 'Move up', down: 'Move down', remove: 'Remove', restaurant: 'Restaurant', output: 'Ready programme', share: 'Share', copied: 'Copied', clear: 'Clear route', return: 'Return to', departureFrom: 'departure from', defaultProgram: 'Add route stops and a ready-to-copy programme will appear here.', recommendations: 'Day recommendations', weather: 'Weather', beach: 'Beach', levada: 'Levada', weatherLoading: 'Loading the current forecastвЂ¦', weatherUnavailable: 'A current forecast is unavailable for the selected date. Check the weather before departure.',
  };

  const locationFilters = [{ value: 'All', label: messages.exploreList.filters.all }, { value: 'Viewpoints', label: messages.exploreList.filters.viewpoints }, { value: 'Hiking', label: messages.exploreList.filters.hiking }, { value: 'Beaches', label: messages.exploreList.filters.beaches }, { value: 'City & culture', label: messages.exploreList.filters.cityCulture }, { value: 'Levada walks', label: messages.exploreList.filters.levadaWalks }, { value: 'Airport', label: locale === 'uk' ? 'РђРµСЂРѕРїРѕСЂС‚' : 'Airport' }, { value: 'Lab Travel', label: 'Lab Travel' }];
  ...
  const mealProgrammeText = (time: string) => {
    ...
    return locale === 'uk' ? `${meal} РІ СЂРµСЃС‚РѕСЂР°РЅС–` : `${meal} at a restaurant`;
  };

  const recommendationLines = useMemo(() => {
    const lines: string[] = [];
    const unavailable = weatherStatus === 'unavailable' ? text.weatherUnavailable : text.weatherLoading;
    if (recommendations.weather) { lines.push(`рџЊ¤пёЏ ${text.weather}`); lines.push(weather ? (locale === 'uk' ? `РЎРµСЂРµРґРЅСЏ С‚РµРјРїРµСЂР°С‚СѓСЂР° Р·Р° РјР°СЂС€СЂСѓС‚РѕРј: Р±Р»РёР·СЊРєРѕ ${Math.round(weather.averageTemperature)}В°C. Р™РјРѕРІС–СЂРЅС–СЃС‚СЊ РґРѕС‰Сѓ: РґРѕ ${Math.round(weather.rainProbability)}%. ${adviceForWeather(weather.averageTemperature, weather.rainProbability, locale)}` : `Average temperature across the route: about ${Math.round(weather.averageTemperature)}В°C. Rain probability: up to ${Math.round(weather.rainProbability)}%. ${adviceForWeather(weather.averageTemperature, weather.rainProbability, locale)}`) : unavailable, ''); }
    if (recommendations.beach) { lines.push(`рџЏ–пёЏ ${text.beach}`); lines.push(weather?.waterTemperature !== null && weather?.waterTemperature !== undefined ? (locale === 'uk' ? `РўРµРјРїРµСЂР°С‚СѓСЂР° РІРѕРґРё Р±С–Р»СЏ РњР°РґРµР№СЂРё: Р±Р»РёР·СЊРєРѕ ${Math.round(weather.waterTemperature)}В°C.` : `Sea temperature around Madeira: about ${Math.round(weather.waterTemperature)}В°C.`) : unavailable); lines.push(locale === 'uk' ? 'Р’С–Р·СЊРјС–С‚СЊ РїС–РґСЃС‚РёР»РєРё, РїРѕРІРЅРёР№ РєРѕРјРїР»РµРєС‚ РґР»СЏ РєСѓРїР°РЅРЅСЏ, СЃРѕРЅСЏС‡РЅС– РѕРєСѓР»СЏСЂРё, СЃРѕРЅС†РµР·Р°С…РёСЃРЅРёР№ РєСЂРµРј С– РіРѕР»РѕРІРЅРёР№ СѓР±С–СЂ.' : 'Bring beach mats, a full swim kit, sunglasses, sunscreen and a hat.', ''); }
    if (recommendations.levada) { lines.push(`рџЊї ${text.levada}`); lines.push(locale === 'uk' ? 'Р’С–Р·СЊРјС–С‚СЊ Р·СЂСѓС‡РЅРµ РІР·СѓС‚С‚СЏ РґР»СЏ Р»РµРІР°РґРё Р· С…РѕСЂРѕС€РёРј Р·С‡РµРїР»РµРЅРЅСЏРј. РЇРєС‰Рѕ Р»РµРІР°Р»Р° РІРёР№С€Р»Р° Р· Р±РµСЂРµРіС–РІ Р°Р±Рѕ СЃС‚РµР¶РєР° РјРѕРєСЂР°, РІС–Р·СЊРјС–С‚СЊ РІРѕРґРѕРЅРµРїСЂРѕРЅРёРєРЅС– С‡РѕС…Р»Рё, С‰РѕР± РЅРµ РїСЂРѕРјРѕРєР»Рё РЅРѕРіРё. Р’РѕРґР° РѕР±РѕРІвЂ™СЏР·РєРѕРІР°. РЈСЃС–Рј, С…С‚Рѕ РІРёС‰РёР№ Р·Р° 175 СЃРј, РїРѕС‚СЂС–Р±РЅРѕ СѓРІР°Р¶РЅРѕ РїСЂРѕС…РѕРґРёС‚Рё С‚СѓРЅРµР»С–: С” СЂРёР·РёРє РІРґР°СЂРёС‚РёСЃСЏ РіРѕР»РѕРІРѕСЋ. РЇРєС‰Рѕ Р±РѕС—С‚РµСЃСЏ РІРёСЃРѕС‚Рё, Р№РґС–С‚СЊ РїРѕСЂСѓС‡ С–Р· РіС–РґРѕРј.' : 'Wear comfortable levada shoes with good grip. If the levada has overflowed or the path is wet, take waterproof overshoes to keep your feet dry. Carry water. If you are taller than 175 cm, take care in tunnels because there is a risk of hitting your head. If you are afraid of heights, stay close to your guide.', ''); }
    if (recommendations.sunrise) { lines.push(`рџЊ… ${text.sunrise}`); lines.push(weather?.picoTemperature !== null && weather?.picoTemperature !== undefined ? (locale === 'uk' ? `РќР° Pico do Areeiro: Р±Р»РёР·СЊРєРѕ ${Math.round(weather.picoTemperature)}В°C, РІС–С‚РµСЂ РґРѕ ${Math.round(weather.picoWindSpeed ?? 0)} РєРј/РіРѕРґ, РїРѕСЂРёРІРё РґРѕ ${Math.round(weather.picoWindGusts ?? 0)} РєРј/РіРѕРґ.` : `At Pico do Areeiro: about ${Math.round(weather.picoTemperature)}В°C, wind up to ${Math.round(weather.picoWindSpeed ?? 0)} km/h and gusts up to ${Math.round(weather.picoWindGusts ?? 0)} km/h.`) : unavailable); lines.push(locale === 'uk' ? 'РћРґСЏРіРЅС–С‚СЊ С‚РµРїР»РёР№ С€Р°СЂ, РІС–С‚СЂРѕР·Р°С…РёСЃРЅСѓ РєСѓСЂС‚РєСѓ, РґРѕРІРіС– С€С‚Р°РЅРё С‚Р° Р·Р°РєСЂРёС‚Рµ РІР·СѓС‚С‚СЏ. РџРµСЂРµРґ РІРёС—Р·РґРѕРј Р±Р°Р¶Р°РЅРѕ Р·вЂ™С—СЃС‚Рё С‰РѕСЃСЊ Р»РµРіРєРµ: РєР°РІСѓ Р· С‚С–СЃС‚РµС‡РєРѕРј Р°Р±Рѕ Р±СѓС‚РµСЂР±СЂРѕРґРё. РЎРєРѕСЂРёСЃС‚Р°Р№С‚РµСЃСЏ С‚СѓР°Р»РµС‚РѕРј РїРµСЂРµРґ РІРёС—Р·РґРѕРј.' : 'Wear a warm layer, windproof jacket, long trousers and closed shoes. Before leaving, have something light such as coffee and a pastry or sandwiches. Use the toilet before departure.', ''); }
    return lines;
  }, [locale, recommendations, text, weather, weatherStatus]);

  const programme = useMemo(() => {
    if (stops.length === 0) return '';
    const selectedDate = new Date(`${date}T12:00:00`); const formattedDate = new Intl.DateTimeFormat(locale === 'uk' ? 'uk-UA' : 'en-GB', { day: 'numeric', month: 'long' }).format(selectedDate); const ukrainianWeekdays = ['РЅРµРґС–Р»СЋ', 'РїРѕРЅРµРґС–Р»РѕРє', 'РІС–РІС‚РѕСЂРѕРє', 'СЃРµСЂРµРґСѓ', 'С‡РµС‚РІРµСЂ', 'РївЂ™СЏС‚РЅРёС†СЋ', 'СЃСѓР±РѕС‚Сѓ']; const englishWeekday = new Intl.DateTimeFormat('en-GB', { weekday: 'long' }).format(selectedDate); const heading = locale === 'uk' ? `РџСЂРѕРіСЂР°РјР° РЅР° ${ukrainianWeekdays[selectedDate.getDay()]}, ${formattedDate}` : `Programme for ${englishWeekday}, ${formattedDate}`; const lines = [heading, '', `рџљЊ ${departureTime} вЂ” ${text.departureFrom} ${selectedVilla.name}, ${locale === 'uk' ? 'РїСЂРёР±СѓС‚С‚СЏ' : 'arrival'} ~${stops[0] ? stops[0].arrivalTime : addMinutes(departureTime, 30)}.`, '']; const endsAtAirport = stops[stops.length - 1]?.type === 'location' && stops[stops.length - 1]?.slug === 'madeira-international-airport';
    stops.forEach((stop) => { const endTime = addMinutes(stop.arrivalTime, stop.durationMinutes); if (stop.type === 'restaurant') { lines.push(`рџЌЅпёЏ ${stop.arrivalTime}вЂ“${endTime} вЂ” ${mealProgrammeText(stop.arrivalTime)}.`, ''); return; } if (stop.type === 'villa') { lines.push(`рџЏЎ ${stop.arrivalTime}вЂ“${endTime} вЂ” ${selectedVilla.name}.`, `https://madeiralivecams.com/${locale}/stays/${selectedVilla.slug}`, ''); return; } if (stop.type === 'location' && stop.slug === 'madeira-international-airport') { const airport = locationBySlug.get(stop.slug); if (airport) lines.push(`вњ€пёЏ ${stop.arrivalTime}вЂ“${endTime} вЂ” ${airport.name}.`, `https://madeiralivecams.com/${locale}/explore/${airport.slug}`, ''); return; } const location = stop.slug ? locationBySlug.get(stop.slug) : undefined; if (!location) return; const icon = location.tags.includes('Beaches') ? 'рџЏ–пёЏ' : location.tags.includes('Hiking') ? 'рџЊї' : 'рџ“Ќ'; const sunriseSuffix = stop.slug === 'pico-do-arieiro' && stop.isSunrise ? locale === 'uk' ? ' Р—СѓСЃС‚СЂС–С‡Р°С”РјРѕ СЃС…С–Рґ СЃРѕРЅС†СЏ + РїСЂРѕРіСѓР»СЏРЅРєР° РїРѕ РјР°СЂС€СЂСѓС‚Сѓ PR1 вЂ“ Vereda do Areeiro РґРѕ Miradouro da Pedra Rija.' : ' Sunrise viewing plus a walk on PR1 вЂ“ Vereda do Areeiro to Miradouro da Pedra Rija.' : '';
      const cristovaoSuffix = stop.slug === 'miradouro-sao-cristovao' && (stop.hasCristovaoBar || stop.hasCristovaoRestaurant)
        ? locale === 'uk'
          ? ` + ${stop.hasCristovaoRestaurant ? `${mealProgrammeText(stop.arrivalTime)}, ` : ''}${stop.hasCristovaoBar ? 'РЅР°РїРѕС— С‚Р° РїРµСЂРµРєСѓСЃ Сѓ Р±Р°СЂС–' : ''}`
          : ` + ${stop.hasCristovaoRestaurant ? `${mealProgrammeText(stop.arrivalTime)}, ` : ''}${stop.hasCristovaoBar ? 'drinks and snacks at the bar' : ''}`
        : '';
      lines.push(`${icon} ${stop.arrivalTime}вЂ“${endTime} вЂ” ${location.name}.${sunriseSuffix}${cristovaoSuffix}`, `https://madeiralivecams.com/${locale}/explore/${location.slug}`, ''); });
    if (endsAtAirport) lines.push(locale === 'uk' ? 'рџ­ РќР° С†СЊРѕРјСѓ РїСЂРѕРіСЂР°РјР° С‚СѓСЂСѓ Р·Р°РІРµСЂС€РµРЅР°.' : 'рџ­ The tour programme ends here.'); else lines.push(`рџЏЎ ${text.return} ${selectedVilla.name}.`, `https://madeiralivecams.com/${locale}/stays/${selectedVilla.slug}`);
    if (recommendationLines.length > 0) lines.push('', locale === 'uk' ? 'Р Р•РљРћРњР•РќР”РђР¦Р†Р‡ РќРђ Р”Р•РќР¬' : 'DAY RECOMMENDATIONS', '', ...recommendationLines);
    return lines.join('\n');
  ...
  return <Layout><Head><title>{text.title} | Madeira Live Cams</title><meta name="description" content={text.intro} /></Head><main className="mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-10"><section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-8"><p className="text-sm font-semibold uppercase tracking-wider text-ocean">Madeira Live Cams</p><h1 className="mt-2 text-3xl font-bold tracking-tight text-navy sm:text-4xl">{text.title}</h1><p className="mt-3 max-w-2xl leading-7 text-slate-600">{text.intro}</p>
    ...
    <section className="mt-6"><div className="flex items-center justify-between gap-3"><h2 className="text-xl font-bold text-navy">{text.selectedStops}</h2><button type="button" onClick={calculateRoute} disabled={stops.length === 0 || routeStatus === 'loading'} className="min-h-10 rounded-lg border border-ocean bg-white px-3 text-sm font-bold text-ocean transition hover:bg-ocean hover:text-white disabled:cursor-not-allowed disabled:opacity-50">{routeStatus === 'loading' ? (locale === 'uk' ? 'Розраховуємо...' : 'Calculating...') : (locale === 'uk' ? 'Розрахувати маршрут' : 'Calculate route')}</button>{routeStatus === 'loading' && <span className="text-xs font-semibold text-slate-500">{locale === 'uk' ? 'РћРЅРѕРІР»СЋС”РјРѕ С‡Р°СЃ Сѓ РґРѕСЂРѕР·С–вЂ¦' : 'Updating travel timesвЂ¦'}</span>}{stops.length > 0 && <button type="button" onClick={() => setStops([])} className="text-sm font-semibold text-slate-500 hover:text-ocean">{text.clear}</button>}</div>{stops.length === 0 ? <p className="mt-3 rounded-xl border border-dashed border-slate-300 bg-white p-5 text-sm leading-6 text-slate-500">{text.noStops}</p> : <div className="mt-3 space-y-3">{stops.map((stop, index) => { const location = stop.slug ? locationBySlug.get(stop.slug) : undefined; const name = stop.type === 'restaurant' ? text.restaurant : stop.type === 'villa' ? selectedVilla.name : location?.name ?? ''; const icon = stop.type === 'restaurant' ? 'рџЌЅпёЏ' : stop.type === 'villa' ? 'рџЏЎ' : location?.tags.includes('Beaches') ? 'рџЏ–пёЏ' : location?.tags.includes('Hiking') ? 'рџЊї' : 'рџ“Ќ'; const canSelectSunrise = stop.type === 'location' && stop.slug === 'pico-do-arieiro'; return <article key={stop.id} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm"><div className="flex items-start gap-3"><span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-ocean text-sm font-bold text-white">{index + 1}</span><div className="min-w-0 flex-1"><p className="font-bold text-navy">{icon} {name}</p><p className="mt-1 text-xs text-slate-500">{durationLabel(stop.durationMinutes, locale)}</p></div><button type="button" onClick={() => removeStop(stop.id)} aria-label={text.remove} className="rounded-lg px-2 py-1 text-sm font-semibold text-slate-500 hover:bg-red-50 hover:text-red-600">Г—</button></div><div className="mt-4 grid grid-cols-2 gap-3"><label className="flex flex-col gap-1 text-xs font-semibold text-slate-600">{text.arrival}<input type="time" value={stop.arrivalTime} readOnly className="min-h-10 rounded-lg border border-slate-300 bg-slate-100 px-2 text-sm text-navy" /></label><label className="flex flex-col gap-1 text-xs font-semibold text-slate-600">{text.duration}<select value={stop.durationMinutes} onChange={(event) => updateStop(stop.id, { durationMinutes: Number(event.target.value) })} className="min-h-10 rounded-lg border border-slate-300 px-2 text-sm text-navy focus:border-ocean focus:outline-none">{durationOptions.map((minutes) => <option key={minutes} value={minutes}>{durationLabel(minutes, locale)}</option>)}</select></label></div>{canSelectSunrise && <label className="mt-4 flex min-h-11 cursor-pointer items-center gap-3 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-sm font-semibold text-navy"><input type="checkbox" checked={Boolean(stop.isSunrise)} onChange={(event) => updateStop(stop.id, { isSunrise: event.target.checked })} className="h-4 w-4 rounded border-slate-300 text-ocean focus:ring-ocean" /><span>рџЊ… {text.sunrise}</span></label>}
                    {stop.type === 'location' && stop.slug === 'miradouro-sao-cristovao' && <div className="mt-4 grid grid-cols-2 gap-2"><label className="flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-navy"><input type="checkbox" checked={Boolean(stop.hasCristovaoBar)} onChange={(event) => updateStop(stop.id, { hasCristovaoBar: event.target.checked, durationMinutes: event.target.checked || stop.hasCristovaoRestaurant ? 90 : 30 })} className="h-4 w-4 rounded border-slate-300 text-ocean focus:ring-ocean" />рџҐ¤ {text.bar}</label><label className="flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-navy"><input type="checkbox" checked={Boolean(stop.hasCristovaoRestaurant)} onChange={(event) => updateStop(stop.id, { hasCristovaoRestaurant: event.target.checked, durationMinutes: event.target.checked || stop.hasCristovaoBar ? 90 : 30 })} className="h-4 w-4 rounded border-slate-300 text-ocean focus:ring-ocean" />рџЌЅпёЏ {text.restaurantOption}</label></div>}<div className="mt-3 flex gap-2"><button type="button" onClick={() => moveStop(index, -1)} disabled={index === 0} className="min-h-10 flex-1 rounded-lg border border-slate-200 text-xs font-bold text-navy transition hover:border-ocean hover:text-ocean disabled:opacity-35">в†‘ {text.up}</button><button type="button" onClick={() => moveStop(index, 1)} disabled={index === stops.length - 1} className="min-h-10 flex-1 rounded-lg border border-slate-200 text-xs font-bold text-navy transition hover:border-ocean hover:text-ocean disabled:opacity-35">в†“ {text.down}</button></div></article>; })}</div>}</section>
    {stops.length > 0 && <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-4 sm:p-5"><h2 className="text-xl font-bold text-navy">{text.recommendations}</h2><p className="mt-1 text-sm text-slate-500">{locale === 'uk' ? 'РћР±РµСЂС–С‚СЊ СЂРµРєРѕРјРµРЅРґР°С†С–С—, СЏРєС– РїРѕС‚СЂС–Р±РЅРѕ РґРѕРґР°С‚Рё РґРѕ РіРѕС‚РѕРІРѕС— РїСЂРѕРіСЂР°РјРё.' : 'Choose recommendations to add to the ready programme.'}</p><div className="mt-4 grid gap-2 sm:grid-cols-2"><label className="flex min-h-11 cursor-pointer items-center gap-3 rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-navy"><input type="checkbox" checked={recommendations.weather} onChange={(event) => setRecommendations((current) => ({ ...current, weather: event.target.checked }))} className="h-4 w-4 rounded border-slate-300 text-ocean focus:ring-ocean" />рџЊ¤пёЏ {text.weather}</label>{hasBeach && <label className="flex min-h-11 cursor-pointer items-center gap-3 rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-navy"><input type="checkbox" checked={recommendations.beach} onChange={(event) => setRecommendations((current) => ({ ...current, beach: event.target.checked }))} className="h-4 w-4 rounded border-slate-300 text-ocean focus:ring-ocean" />рџЏ–пёЏ {text.beach}</label>}{hasLevada && <label className="flex min-h-11 cursor-pointer items-center gap-3 rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-navy"><input type="checkbox" checked={recommendations.levada} onChange={(event) => setRecommendations((current) => ({ ...current, levada: event.target.checked }))} className="h-4 w-4 rounded border-slate-300 text-ocean focus:ring-ocean" />рџЊї {text.levada}</label>}{hasSunrise && <label className="flex min-h-11 cursor-pointer items-center gap-3 rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-navy"><input type="checkbox" checked={recommendations.sunrise} onChange={(event) => setRecommendations((current) => ({ ...current, sunrise: event.target.checked }))} className="h-4 w-4 rounded border-slate-300 text-ocean focus:ring-ocean" />рџЊ… {text.sunrise}</label>}</div></section>}
    <section className="mt-8 rounded-2xl border border-slate-200 bg-panel p-4 sm:p-5"><div className="flex flex-wrap items-center justify-between gap-3"><h2 className="text-xl font-bold text-navy">{text.output}</h2><button type="button" onClick={shareProgramme} disabled={!programme} className="min-h-10 rounded-lg bg-ocean px-4 text-sm font-bold text-white transition hover:bg-forest disabled:cursor-not-allowed disabled:opacity-40">{copyStatus === 'copied' ? `вњ“ ${text.copied}` : `в†— ${text.share}`}</button></div><textarea readOnly value={programme || text.defaultProgram} className="mt-4 min-h-[260px] w-full resize-y rounded-xl border border-slate-300 bg-white p-4 font-mono text-sm leading-6 text-slate-700 focus:outline-none" /></section>
  </section></main></Layout>;
}
