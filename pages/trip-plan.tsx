...
>
  ...
  className="flex min-h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-ocean bg-white text-lg font-bold text-ocean transition hover:bg-ocean hover:text-white sm:self-end"
>
  + {'\u{1F37D}\uFE0F'}
</button><button
  type="button"
  ...
  title={text.addVilla}
  className="flex min-h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-slate-300 bg-white text-lg font-bold text-navy transition hover:border-ocean hover:text-ocean sm:self-end"
>
  + {'\u{1F3E1}'}
</button></div></div>
    ...
    <section className="mt-8 rounded-2xl border border-slate-200 bg-panel p-4 sm:p-5"><div className="flex items-center justify-between gap-3"><h2 className="text-xl font-bold text-navy">{text.output}</h2><div className="flex flex-wrap items-center gap-2"><button type="button" onClick={calculateRoute} disabled={stops.length === 0 || routeStatus === 'loading'} className="min-h-10 rounded-lg border border-ocean bg-white px-4 text-sm font-bold text-ocean transition hover:bg-ocean hover:text-white disabled:cursor-not-allowed disabled:opacity-50">{routeStatus === 'loading' ? (locale === 'uk' ? '\u0420\u043e\u0437\u0440\u0430\u0445\u043e\u0432\u0443\u0454\u043c\u043e...' : 'Calculating...') : (locale === 'uk' ? '\u0420\u043e\u0437\u0440\u0430\u0445\u0443\u0432\u0430\u0442\u0438 \u043c\u0430\u0440\u0448\u0440\u0443\u0442' : 'Calculate route')}</button><button
  type="button"
...
</button></div></div><textarea readOnly value={programme || text.defaultProgram} className="mt-4 min-h-[260px] w-full resize-y rounded-xl border border-slate-300 bg-white p-4 font-mono text-sm leading-6 text-slate-700 focus:outline-none" /></section>
  </section></main></Layout>;
}
