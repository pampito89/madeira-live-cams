...
export default function TripPlanPage() {
    ...
    const programme = useMemo(() => {
        ...
        stops.forEach((stop, index) => {
            ...
            const boatSuffix = stop.slug === 'madeira-sea-emotions' && stop.boatDirection ? locale === 'uk' ? stop.boatDirection === 'officeToCafe' ? ' PR8 – Vereda da Ponta de São Lourenço + екскурсійний човен до маяка: офіс Madeira Sea Emotions → Casa de Sardinha, повернення пішки до офісу. Вартість екскурсії — 30 €.' : ' PR8 – Vereda da Ponta de São Lourenço + екскурсійний човен до маяка: спершу пішки від офісу Madeira Sea Emotions до Casa de Sardinha, потім човном через маяк до офісу. Вартість екскурсії — 30 €.' : stop.boatDirection === 'officeToCafe' ? ' PR8 – Vereda da Ponta de São Lourenço + lighthouse boat excursion: Madeira Sea Emotions office → Casa de Sardinha, walk back to the office. Tour price: €30.' : ' PR8 – Vereda da Ponta de São Lourenço + lighthouse boat excursion: first walk from the Madeira Sea Emotions office to Casa de Sardinha, then take the boat via the lighthouse back to the office. Tour price: €30.' : '';
